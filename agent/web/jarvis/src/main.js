...
document.addEventListener('DOMContentLoaded', async function () {
  ...
  if (orbStatus) {
    const labels = { idle: 'IDLE', thinking: 'THINKING...', responding: 'RESPONDING...' };
...
// Flowork: PWA Service Worker DIMATIIN — gak perlu (halaman di dalam GUI) + SW bikin
// aset ke-cache basi. Sekalian unregister SW lama kalau ada (anti-stale).

...
var Registry = []Switch{
	...
	{"FLOWORK_ANTIGRAVITY_MODELS", "Model Antigravity (Gemini via cloud-code)", "Daftar model yg di-advertise provider Antigravity auto (pisah koma). Dipakai pas jalur OAuth (MITM mentok karena app pake DoH). Kosong = provider ga match sampai ada capture MITM. Edit di sini = GUI kebenaran, bukan hardcode. Model asli dari spec Antigravity.", "string", "gemini-3-pro-high,gemini-3-pro-low,claude-sonnet-4-6,claude-opus-4-6-thinking,gpt-oss-120b-medium", "Router / Antigravity"},

...
var Registry = []Switch{
	...
	{"FLOWORK_ANTIGRAVITY_MODELS", "Model Antigravity (Gemini via cloud-code)", "Daftar model yg di-advertise provider Antigravity auto (pisah koma). Dipakai pas jalur OAuth (MITM mentok karena app pake DoH). Kosong = provider ga match sampai ada capture MITM. Edit di sini = GUI kebenaran, bukan hardcode. Model asli dari spec Antigravity.", "string", "gemini-3.1-pro-high,gemini-3.1-pro-low,gemini-3.5-flash-high,gemini-3.5-flash-low", "Router / Antigravity"},

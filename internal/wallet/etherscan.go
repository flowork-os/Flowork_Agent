...
// Reason: Section 21 phase 1 — Etherscan V2 API client. Read-only.
//   ETHERSCAN_API_KEY env required. Phase 2 (paid tier multi-chain,
//   Tron/Solana, Tatum fallback) → tambah file baru.

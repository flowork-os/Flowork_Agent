...
// Reason: Section 21 phase 1 — supported chains + monitored tokens
//   registry (ETH/Polygon/Arbitrum + USDT/USDC/DAI). Phase 2 (env-driven
//   WALLET_EXTRA_TOKENS_<CHAIN_ID>, BSC/OP/Base paid tier) → tambah file baru.
//
...
// view owner sees in Trust Wallet.
//

...
> Data yang masuk brain (`strategy.jsonl`, `improvement.jsonl`) sudah **white-label**:
...
- **Status hukum**: **public domain** (Project Gutenberg eBook #132, rilis 1994; "no cost, almost no restrictions"). PD ga butuh atribusi — aman di-white-label.
...
- **Status hukum**: prinsip/fakta **tidak bisa di-hak-cipta**; pernyataan ditulis ulang **dengan kata-kata kita sendiri** (bukan salinan teks), jadi ga butuh atribusi & aman white-label. Buku kanon Kaizen (Masaaki Imai, 1986) **tidak** dipakai/disalin (hak cipta).
...
```json
{"id":"strategy-0001","lens":"strategy","pattern":"<teks pola, white-label>"}
{"id":"improvement-0001","lens":"improvement","pattern":"<teks pola, white-label>"}
```
